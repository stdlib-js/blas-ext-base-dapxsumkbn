...
var dapxsumkbn = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dapxsumkbn.length, 5, 'returns expected value' );
	t.end();
});
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `0.0`', opts, function test( t ) {
	...
	v = dapxsumkbn( 0, 5.0, x, 1, 0 );
	t.strictEqual( v, 0.0, 'returns expected value' );

	v = dapxsumkbn( -1, 5.0, x, 1, 0 );
	t.strictEqual( v, 0.0, 'returns expected value' );
